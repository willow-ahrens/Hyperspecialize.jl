...
[![AppVeyor](https://ci.appveyor.com/project/myaccount/myproject/branch/master?svg=true)](https://ci.appveyor.com/api/projects/status/32r7s2skrgm9ubva/branch/master?svg=true)
